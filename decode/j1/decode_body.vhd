    ...
    begin
        case code(15 downto 12) is
            when x"0" =>
                ...
                -- 0000 ---- 0101 1010 => 11000101  STS CPI_COM, Rn
                ...
                addr(1) := not ((not code(0) and not code(1) and not code(2) and code(3) and not code(4) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (not code(0) and code(1) and not code(2) and code(3) and not code(4) and not code(5) and not code(6) and not code(7)) or (not code(0) and code(1) and not code(2) and code(3) and code(4) and not code(5) and code(6) and not code(7)) or (not code(0) and code(1) and code(2) and code(3)) or (code(0) and not code(1) and code(2)) or (code(0) and code(1) and not code(2) and code(3) and not code(4) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (not code(1) and code(2) and not code(3)) or (code(1) and not code(2) and not code(3) and not code(4) and code(5) and not code(6) and not code(7)));
            ...
            when x"2" =>
                ...
                -- 0010 ---- ---- 0011 => 11000101  CAS.L Rm, Rn, @R0
                ...
                addr(4) := (not code(0) and code(1) and not code(2)) or (not code(0) and not code(2) and not code(3)) or (code(0) and not code(1) and not code(2)) or (code(0) and code(1) and code(2) and not code(3)) or (not code(1) and code(2) and code(3));
                addr(5) := (not code(0) and not code(2)) or (code(0) and code(2) and code(3)) or (not code(1) and not code(2) and not code(3)) or (code(1) and code(3));
            ...
            when x"4" =>
                ...
                -- 0100 ---- 1000 1001 => 11000101  CLDS CP0_Rm, CP0_COM
                -- 0100 ---- 1000 1000 => 11000101  LDS Rm, CP0_COM
                -- 0100 ---- 0101 1010 => 11000101  LDS Rm, CPI_COM
                -- 0100 ---- 1100 1001 => 11000101  CSTS CP0_COM, CP0_Rn
                -- 0100 ---- 1100 1000 => 11000101  STS CP0_COM, Rn
                ...
                addr(4) := not ((not code(0) and code(1) and not code(2) and code(3) and code(4) and not code(5) and code(6) and not code(7)) or (not code(0) and code(1) and code(2) and not code(3) and not code(4) and not code(6) and not code(7)) or (code(0) and code(1) and not code(2) and not code(3) and not code(5) and not code(6) and not code(7)) or (code(0) and code(1) and not code(2) and code(4) and not code(5) and not code(6) and not code(7)) or (not code(1) and not code(2) and code(3) and not code(4) and not code(5) and code(7)) or (not code(1) and not code(2) and code(3) and not code(4) and code(5) and not code(6) and not code(7)) or (code(1) and code(2) and not code(3) and not code(4) and code(5) and not code(6) and not code(7)) or (code(1) and code(2) and not code(3) and code(4) and not code(5) and not code(6) and not code(7)));
                addr(5) := not ((not code(0) and code(1) and not code(2) and code(3) and code(4) and not code(5) and code(6) and not code(7)) or (not code(0) and code(1) and code(2) and not code(3) and not code(5) and not code(6) and not code(7)) or (code(0) and code(2) and not code(3) and code(4) and not code(5) and not code(6) and not code(7)) or (not code(1) and not code(2) and code(3) and not code(4) and not code(5) and code(7)) or (not code(1) and not code(2) and not code(5) and not code(6) and not code(7)) or (not code(1) and not code(3) and not code(4) and not code(6) and not code(7)) or (code(2) and not code(3) and not code(4) and code(5) and not code(6) and not code(7)));
            ...
            when x"F" =>
                -- 1111 ---- 0000 1101 => 11000101  CSTS CPI_COM, CPI_Rn
                -- 1111 ---- 0001 1101 => 11000101  CLDS CPI_Rm, CPI_COM
                addr(0) := '1';
                addr(1) := '0';
                addr(2) := '1';
                addr(3) := '0';
