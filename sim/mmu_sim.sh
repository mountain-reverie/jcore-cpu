...
if [ $# -ge 1 ]; then
  ...
  for t in exctest trapatest pm3vec pm3guard privmode banktest excguard \
           ...
           mmustale mmuasid mmuglobal mmumultihit mmudblflt mmunest_trapa mmunest_slotill mmunest mmuremap mmucmpcsr mmurun mmubench mmubenchi mmuirun mmuainc mmuainc2 mmusmep j4_illegal_trap; do
    run_guard "$t"
  done
