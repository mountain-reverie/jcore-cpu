    ...
    "synth-size": [
      { commit: { id: "aaa1111", message: "first", timestamp: "2026-06-10T00:00:00Z", url: "#" }, date: 1700000000000,
        benches: [
          ...
          { name: "asic-nangate45 · cpu/area", unit: "um2", value: 51200, extra: "j4" },
          { name: "ecp5-lfe5u-85f · cpu/LUT4", unit: "LUT4", value: 7350, extra: "j4" } ] },
      { commit: { id: "bbb2222", message: "second", timestamp: "2026-06-11T00:00:00Z", url: "#" }, date: 1700086400000,
        benches: [
          ...
          { name: "asic-nangate45 · cpu/area", unit: "um2", value: 38500, extra: "j1" },
          { name: "asic-nangate45 · cpu/area", unit: "um2", value: 50900, extra: "j4" },
          { name: "ecp5-lfe5u-85f · cpu/LUT4", unit: "LUT4", value: 5200, extra: "j1" },
          { name: "ecp5-lfe5u-85f · cpu/LUT4", unit: "LUT4", value: 7200, extra: "j4" } ] }
    ],
    "synth-speed": [
      { commit: { id: "aaa1111", message: "first", timestamp: "2026-06-10T00:00:00Z", url: "#" }, date: 1700000000000,
        benches: [ { name: "asic-nangate45 · cpu/Fmax (relative)", unit: "MHz", value: 39.5, extra: "direct-rom72" },
                   ...
                   { name: "asic-nangate45 · cpu/Fmax (relative)", unit: "MHz", value: 44.1, extra: "j4" },
                   { name: "ecp5-lfe5u-85f · cpu/Fmax (representative)", unit: "MHz", value: 46.3, extra: "j4" } ] },
      { commit: { id: "bbb2222", message: "second", timestamp: "2026-06-11T00:00:00Z", url: "#" }, date: 1700086400000,
        benches: [ { name: "asic-nangate45 · cpu/Fmax (relative)", unit: "MHz", value: 40.27, extra: "direct-rom72" },
                   ...
                   { name: "asic-nangate45 · cpu/Fmax (relative)", unit: "MHz", value: 35.6, extra: "j1" },
                   { name: "asic-nangate45 · cpu/Fmax (relative)", unit: "MHz", value: 45.0, extra: "j4" },
                   { name: "ecp5-lfe5u-85f · cpu/Fmax (representative)", unit: "MHz", value: 38.5, extra: "j1" },
                   { name: "ecp5-lfe5u-85f · cpu/Fmax (representative)", unit: "MHz", value: 47.1, extra: "j4" } ] }
    ]
  }
};
