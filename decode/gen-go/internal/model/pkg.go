...
type Package struct {
	...
	DecCoreROMResetAddr string            // hex byte, e.g. "e2"
...
func newStaticPackage() *Package {
	return &Package{
		StaticEnums: []EnumType{
			...
			{Name: "sr_sel_t", Literals: []string{"SEL_PREV", "SEL_WBUS", "SEL_ZBUS", "SEL_DIV0U", "SEL_ARITH", "SEL_LOGIC", "SEL_INT_MASK", "SEL_SET_T"}},
