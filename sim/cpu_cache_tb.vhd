...
entity cpu_cache_tb is
end cpu_cache_tb;

architecture behaviour of cpu_cache_tb is
  ...
  -- D-cache cacheability router between the CPU data port and the bus master.
  signal cpu_db_o    : cpu_data_o_t;
  signal cpu_db_i    : cpu_data_i_t;
...
begin
  ...
  cpu1: configuration work.cpu_sim
            ...
            port map(clk => clk, rst => rst,
                     db_o => cpu_db_o, db_lock => cpu_db_lock, db_i => cpu_db_i,
