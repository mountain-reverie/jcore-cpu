...
begin
  ...
  begin -- begin of process ( )
    ...
    -- PIPT: cpu.vhd relocates the fetch address upstream of the cache, so a.a
    -- is already a PA; index and tag are both physical in every mode.
...
this_c <= this;
  ...
  ry_ccl.ten <= '1';
  ry_ccl.tag <= (CACHE_PA_TAG_WIDTH-CACHE_TAG_WIDTH-1 downto 0 => '0')
