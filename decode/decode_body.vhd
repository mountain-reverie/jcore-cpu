    ...
    begin
        case code(15 downto 12) is
            when x"0" =>
                ...
                addr(0) := (not code(0) and not code(1) and not code(2) and code(3) and not code(4) and code(5) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (not code(0) and not code(1) and not code(2) and code(3) and code(4) and not code(5) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (not code(0) and code(1) and not code(2) and not code(3) and not code(4) and not code(7)) or (not code(0) and code(1) and not code(2) and not code(3) and code(7)) or (not code(0) and code(1) and not code(2) and code(3) and code(4) and not code(5) and not code(6) and not code(7)) or (not code(0) and code(2) and not code(3)) or (code(0) and not code(2) and code(3) and not code(4) and not code(5) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (code(0) and code(2) and code(3)) or (code(1) and not code(2) and not code(3) and not code(4) and not code(6) and not code(7));
                ...
                addr(2) := (not code(0) and code(1) and not code(2) and code(3) and not code(4) and not code(6) and not code(7)) or (not code(0) and code(1) and not code(2) and code(3) and code(4) and not code(5) and not code(7)) or (not code(0) and code(1) and not code(2) and code(4) and not code(5) and code(6) and not code(7)) or (code(0) and code(1) and not code(2) and not code(3) and not code(4) and not code(5) and not code(6) and not code(7)) or (code(0) and code(1) and not code(2) and not code(3) and code(5) and code(6) and not code(7)) or (code(0) and code(1) and not code(2) and code(3) and not code(4) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (code(0) and code(1) and not code(2) and code(3) and code(5) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (code(0) and code(2)) or (not code(1) and code(2) and code(3)) or (code(1) and not code(2) and not code(3) and not code(4) and code(5) and code(6) and not code(7)) or (code(1) and code(2) and not code(3));
                addr(3) := (not code(0) and not code(1) and not code(2) and code(3) and code(4) and not code(5) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (not code(0) and code(1) and code(2) and code(3)) or (code(0) and code(1) and not code(2) and not code(3) and code(4) and code(6) and not code(7)) or (code(0) and code(1) and not code(2) and not code(3) and code(5) and code(6) and not code(7)) or (code(0) and code(1) and not code(2) and code(3) and code(4) and not code(6) and not code(7) and not code(8) and not code(9) and not code(10) and not code(11)) or (code(0) and code(1) and code(2) and not code(3)) or (code(1) and not code(2) and not code(3) and code(4) and code(5) and code(6) and not code(7));
                ...
                addr(6) := (not code(0) and code(1) and not code(2) and not code(3) and code(4) and code(5) and not code(7)) or (not code(0) and code(1) and not code(2) and not code(3) and code(6) and not code(7)) or (not code(0) and code(1) and not code(2) and not code(3) and code(7)) or (code(0) and code(1) and not code(2) and not code(3) and not code(4) and code(5) and not code(7)) or (code(0) and code(1) and not code(2) and not code(3) and not code(4) and not code(6) and not code(7)) or (code(0) and code(1) and code(2) and not code(3)) or (code(1) and not code(2) and not code(3) and code(4) and code(6) and not code(7));
                addr(7) := (not code(0) and code(1) and not code(2) and not code(3) and code(4) and code(5) and not code(7)) or (not code(0) and code(1) and not code(2) and not code(3) and code(6) and not code(7)) or (not code(0) and code(1) and not code(2) and not code(3) and code(7)) or (not code(0) and code(2)) or (not code(1) and code(2)) or (code(1) and not code(2) and not code(3) and code(4) and code(6) and not code(7)) or (code(1) and not code(2) and not code(3) and code(5) and code(6) and not code(7)) or (code(2) and code(3));
                addr(8) := '0';
