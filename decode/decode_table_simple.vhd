...
begin
    ...
    begin
        ...
        elsif std_match(cond, "1----1000--------") then
            -- Illegal TLB IMISS [0800]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "1----1001--------") then
            -- Illegal TLB DMISS R [0900]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "1----1010--------") then
            -- Illegal TLB DMISS W [0A00]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "1----1011--------") then
            -- Illegal TLB IPROT [0B00]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "1----1100--------") then
            -- Illegal TLB DPROT R [0C00]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "1----1101--------") then
            -- Illegal TLB DPROT W [0D00]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000--------0000") then
            -- Illegal MOVI20 #imm20,Rn [0000]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000--------0001") then
            -- Illegal MOVI20S #imm20,Rn [0001]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----00110010") then
            -- Illegal STC SSR, Rn [0032]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01000010") then
            -- Illegal STC SPC, Rn [0042]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01000011") then
            -- Illegal STC TSBPTR, Rn [0043]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01010010") then
            -- Illegal STC EXPEVT, Rn [0052]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01010011") then
            -- Illegal STC PTEH, Rn [0053]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01100010") then
            -- Illegal STC INTEVT, Rn [0062]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01100011") then
            -- Illegal STC PTEL, Rn [0063]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01110010") then
            -- Illegal STC TRA, Rn [0072]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----01110011") then
            -- Illegal STC ASIDR, Rn [0073]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000----1---0010") then
            -- Illegal STC Rm_BANK, Rn [0082]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10000000000111000") then
            -- Illegal LDTLB [0038]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
        ...
        elsif std_match(cond, "10000000001111000") then
            -- Illegal LDTLB.RN [0078]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10011--------0001") then
            -- Illegal MOV.L @(disp12,Rm),Rn [3001]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----00111110") then
            -- Illegal LDC Rm, SSR [403E]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----01001110") then
            -- Illegal LDC Rm, SPC [404E]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----01011110") then
            -- Illegal LDC Rm, PTEH [405E]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----01101110") then
            -- Illegal LDC Rm, PTEL [406E]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----01111110") then
            -- Illegal LDC Rm, ASIDR [407E]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----1---1110") then
            -- Illegal LDC Rm, Rn_BANK [408E]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----11110000") then
            -- Illegal MOVMU.L Rm,@-R15 [40F0]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----11110001") then
            -- Illegal MOVML.L Rm,@-R15 [40F1]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----11110100") then
            -- Illegal MOVMU.L @R15+,Rn [40F4]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
        ...
        elsif std_match(cond, "10100----11110101") then
            -- Illegal MOVML.L @R15+,Rn [40F5]
            -- 
            case op.addr(3 downto 0) is
                when x"0" =>
                    ex.aluiny_sel <= SEL_IMM;
