...
entity cpu_cache_timing_top is
  ...
  port (
    clk  : in    std_logic; -- single clock (drives cpu + cache clk125/clk200)
    rst  : in    std_logic;
...
end entity cpu_cache_timing_top;
...
architecture timing of cpu_cache_timing_top is
  ...
  signal ic_burst           : std_logic;
  signal dc_burst           : std_logic;
  signal dc_dbus_lock       : std_logic;
...
begin
  ...
  u_icache : component icache_adapter
    ...
    port map (
      ...
      ibus_i        => inst_i,
      dbus_o        => ic_ddr_o,
      dbus_ddrburst => ic_burst,
      dbus_i        => ic_ddr_i,
      dbus_ack_r    => acc(23)
    );

  u_dcache : component dcache_adapter
