...
if [ $# -ge 1 ]; then
  ...
  for t in exctest trapatest pm3vec pm3guard privmode banktest excguard \
           ...
           mmusr mmufault mmufsr mmudslot mmuidslot mmuldtlbr mmutsb mmuwalkhit mmuwalkmiss mmuwalkstale mmuwalktorn mmuwalkdside mmuwalkiside mmuwalkorder mmutsbslot mmuidx mmustres mmustr2 mmuimissrest mmushadowld mmushadowst mmurestartpc \
