          ...
          if this.slot = '1' then
            ...
            if (mem.issue = '1' and this.data_o.en = '0'
              ...
              if PRIV_ARCH then
                ...
                -- leading, 0xFF001010 would decode as MMUCR and the PMU would
                -- be unreachable at any offset that collides with an MMU
                -- register. Ordering it first also means NO address outside
                ...
                elsif ma_ad(7 downto 0) = x"00" then p4_sel_v := P4_PTEH;
