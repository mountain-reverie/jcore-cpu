...
package cpu2j0_pack is
  ...
  type cpu_instruction_o_t is record
    ...
    jp : std_logic;
  end record cpu_instruction_o_t;
  ...
  type cpu_instruction_i_t is record
    ...
    ack : std_logic;
  end record cpu_instruction_i_t;
  ...
  end record cpu_event_i_t;

  constant null_cpu_event_i : cpu_event_i_t :=
  (
    en  => '0',
    cmd => INTERRUPT,
    vec => (others => '0'),
  ...
  function loopback_bus (
    b : cpu_data_o_t
  ) return cpu_data_i_t;

end package cpu2j0_pack;
