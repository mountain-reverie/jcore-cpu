...
- **Unit TB:** `sim/tlb_tb.vhd` (25 cases: install/lookup, ASID isolation,
  GLOBAL, STALE, page masks, install dedup, multi-hit, the U/MD and SMEP and W
  protection predicates, and warm reset), `sim/tests/tlbwalk.c`. It runs from
  `sim/mmu_sim.sh` and `.github/workflows/full-regression.yml`.
  `sim/tlb_match_tb.vhd` was retired 2026-08-23 -- a subset of the above, and
  rotted; see the note in `sim/Makefile`.
