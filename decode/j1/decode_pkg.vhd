...
package decode_pack is
    ...
    constant DEC_CORE_ROM_RESET : decode_core_reg_t := (maskint => '0', delay_slot => '0', id_stall => '0', instr_seq_zero => '0', op => (plane => SYSTEM_INSTR, code => x"0300", addr => x"d6"), ilevel => x"0");
    ...
    constant system_instr_rom_addrs : system_instr_addr_array := (BREAK => x"ee", ERROR => x"e5", GENERAL_ILLEGAL => x"c5", INTERRUPT => x"dc", RESET_CPU => x"d5", SLOT_ILLEGAL => x"cd");
