...
| Build | Flat cells | Δ |
|---|---:|---|
| j4c PRIV-only, historical (was `MMU_ARCH=false`) | 542,091 | — |
| j4c PRIV+MMU (current `cpu_cache_timing_j4_priv_mmu`, `PRIV_ARCH=true`) | 551,106 | **+9,015 (+1.66 %)** |

**The PRIV-only row is historical only.** It was measured before `MMU_ARCH` was
