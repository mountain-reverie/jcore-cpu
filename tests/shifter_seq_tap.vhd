...
architecture tb of shifter_seq_tap is
  ...
  signal          t_seq        : std_logic;
  signal          t_cmb        : std_logic;
...
begin
  ...
  u_cmb : entity work.shifter(comb)
    port map (
      clk   => clk,
      rst   => rst,
      start => '0',
  ...
  process is
    ...
    type vec_t is record
      op : shiftfunc_t; a : std_logic_vector(31 downto 0); n : integer;
    end record vec_t;
