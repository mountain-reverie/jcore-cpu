...
, dev_i2c
  ...
  function mask_data_o (
    d: cpu_data_o_t;
    en : std_logic
  )
    return cpu_data_o_t;

  function decode_data_address (
    addr : std_logic_vector(31 downto 0)
  )
    return data_bus_device_t;

  procedure data_buses (
  ...
  procedure splice_instr_data_bus (
    signal instr_o : in cpu_instruction_o_t;
...
package body data_bus_pkg is
  ...
  end procedure instruction_buses;
  ...
  end procedure splice_instr_data_bus;

end package body data_bus_pkg;
