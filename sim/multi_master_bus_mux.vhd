...
entity multi_master_bus_mux is
  port (
    rst     : in    std_logic;
    clk     : in    std_logic;
...
end entity multi_master_bus_mux;
...
architecture a of multi_master_bus_mux is
  ...
  (
    ...
    m1        => ((others => '0'), '0'),
    m2        => ((others => '0'), '0'),
    slave     => ('0', (others => '0'), '0', '0', "0000", (others => '0')),
    slave_ack => '0'
  );
...
begin
  ...
  p1 : process (this_r, m1_o, m2_o, slave_i) is
  ...
  begin
    ...
    if ((m1_o.en = '1' or m2_o.en = '0') and
        (this.state = m1 or (this.state = m2 and this.slave_ack = '1'))) then
      this.state  := m1;
